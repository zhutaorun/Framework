namespace GameFrame.Utils
{
    ...
    public class KeyedPriorityQueue<K,V,P> where V:class
    {
        ...
        private void Heapify(int i)
        {
            ...
            if((num2<= this.size) && this.IsHigher(this.heap[num].Priority, this.heap[j].Priority))
            {
                j = num2;
            }
        ...
        public struct HeapNode<KK,VV,PP>
        {
            public KK Key;
            public VV Value;
            public PP Priority;
