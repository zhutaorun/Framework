...
namespace UnityEngine.UI.Extension.Utils
{
    ...
    public class XMLIterator
    {
        ...
        public static int sourceLen;
        public static int parsePos;
        public static int tagPos;
        public static int tagLength;
        public static int lastTagEnd;
        public static int tagOffset;
        ...
        public static Dictionary<string,string> GetAttributes(Dictionary<string,string> result)
        {
            ...
            else //这里没有先Parsettributes再赋值给resuklt是为了节省复制的操作
        ...
        public static Hashtable GetAttributes(Hashtable result)
        {
            ...
            if(attrParsed)
            {
                ...
                //这里没有先Parsettributes再赋值给resuklt是为了节省复制的操作
                ParseAttributes(result);
            return result;
        }
